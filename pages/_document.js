  ...
  return (
    <Html lang="en">
      <Head>
        ...
        />
        <meta name="keywords" content="Sandeep - Portfolio Template" />
        <meta name="description" content="Sandeep - Portfolio Template" />
        {/* title */}
        <title>Sandeep - Portfolio React NextJS Template</title>
        {/* Favicon */}
